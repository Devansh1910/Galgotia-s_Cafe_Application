...
class otpsection : AppCompatActivity() {
    ...
    private lateinit var phonNumber: String

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_otpsection)



        OTP = intent.getStringExtra("OTP").toString()
        resendToken = intent.getParcelableExtra("resendToken")!!
        phonNumber = intent.getStringExtra("phoneNumber")!!
    ...
    private fun resendVerificationCode(){
        val options = PhoneAuthOptions.newBuilder(auth)
            .setPhoneNumber(phonNumber) // Phone number to verify
